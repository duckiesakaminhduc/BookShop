...
@WebServlet(urlPatterns = "/load4")
public class LoadOnly4Servlet extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<BooksAdd> listBook4 = new BookDAOImpl(new DBConnect().getConn()).getTop4(row, 4);
